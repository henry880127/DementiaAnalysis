...
class EEGNetAttention:
    ...
    def build(self):
        ...
        ##################################################################
        block1 = Conv2D(self.F1, (1, self.kernLength), padding='same', strides=self.strides,
        ...
        block1 = AveragePooling2D(self.avgPoolSize_b1, name='b1_AvgPool')(block1)
        ...
        # Add self_attention with multiheas
        block2 = MultiHeadAttention(num_heads=self.n_heads, 
                                    key_dim=self.attention_dim, value_dim=self.attention_dim, 
                                    name='MultiHeadAttention')(block2, block2)
    ...
    def fit(self, X_train, y_train, X_val, y_val):
        ...
        model.summary()
        print("MultiHeadAttention Is Applied")
