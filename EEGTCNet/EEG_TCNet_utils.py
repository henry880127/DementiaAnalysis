...
from tensorflow.keras.layers import Dropout, Add, Lambda,DepthwiseConv2D,Input, Permute, Dense, Activation
from tensorflow.keras.constraints import max_norm


def EEGTCNet_build(nb_classes,Chans=64, Samples=128, layers=3, kernel_s=10,filt=10, dropout=0, activation='relu', 
    ...
    EEGNet_sep = EEGNet(input_layer=input1,F1=F1,kernLength=kernLength,D=D,Chans=Chans,dropout=dropout_eeg)
...
def EEGNet(input_layer,F1=4,kernLength=64,D=2,Chans=22,dropout=0.1):
    F2= F1*D
    block1 = Conv2D(F1, (1, kernLength), padding = 'same',data_format='channels_first',use_bias = False)(input_layer)
