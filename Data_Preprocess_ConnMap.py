...
class Data_Preprocess_PSDCNN:
    def __init__(self, data, info, **kwargs):
        ...
        self.sec_Overlap = 0
        self.Fs = 500
        self.band = [2,50] # band pass to "band" Hz
        self.target_Freq = 500 # downsample to "target_freq" Hz
        self.conduct_filter = True  # Whether to band-pass filter
        self.conduct_decimate = False  # Whether to downsample
        self.conduct_Czrrf = True # Whether to conduct CZ re-reference
