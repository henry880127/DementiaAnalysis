...
import datetime
from EEG_TCNet_utils import EEGTCNet_build
...
class EEG_TCNet:
    ...
    def build(self):
        ...
        Model = EEGTCNet_build(self.num_class, Chans=self.Chans, Samples=self.Samples, layers=3, kernel_s=10, filt=10, dropout=0, 
                         activation='relu', F1=self.F1, D=self.D, kernLength=self.kernLength, dropout_eeg=self.dropout_rate)
        return Model
